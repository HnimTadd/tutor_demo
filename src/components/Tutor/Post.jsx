...
const Post = (props) => {
  ...
  return <div className="flex flex-col gap-[15px] py-6 px-[45px] rounded-[20px] border bg-white">
    <div className="flex flex-row justify-start items-start gap-5 border-b border-b-slate-400 pb-4">
      <Avatar width='50px' height='50px' onClick={() => {navigate('/personalpage/?id='+post.ownId);}}></Avatar>
